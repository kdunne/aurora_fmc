...
--               /home/pixdaq/kdunne/fmc_one_lane/aurora_fmc/aurora_fmc.srcs/sources_1/ip/cmd_iserdes/cmd_iserdes_funcsim.vhdl
-- Design      : cmd_iserdes
...
entity cmd_iserdes is
  ...
  attribute CORE_GENERATION_INFO of cmd_iserdes : entity is "cmd_iserdes,selectio_wiz_v5_1,{component_name=cmd_iserdes,bus_dir=INPUTS,bus_sig_type=DIFF,bus_io_std=LVDS,use_serialization=false,use_phase_detector=false,serialization_factor=4,enable_bitslip=false,enable_train=false,system_data_width=1,bus_in_delay=NONE,bus_out_delay=NONE,clk_sig_type=SINGLE,clk_io_std=LVCMOS18,clk_buf=BUFIO2,active_edge=RISING,clk_delay=NONE,selio_bus_in_delay=NONE,selio_bus_out_delay=NONE,selio_clk_buf=BUFIO,selio_active_edge=SDR,selio_ddr_alignment=SAME_EDGE_PIPELINED,selio_oddr_alignment=SAME_EDGE,ddr_alignment=C0,selio_interface_type=NETWORKING,interface_type=NETWORKING,selio_bus_in_tap=0,selio_bus_out_tap=0,selio_clk_io_std=LVDS,selio_clk_sig_type=DIFF}";
  attribute SYS_W : integer;
