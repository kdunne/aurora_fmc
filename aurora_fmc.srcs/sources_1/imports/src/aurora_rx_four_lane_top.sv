...
module aurora_fmc_num_lane_top (
    input sysclk_in_p,
    input sysclk_in_n,
    input rst_in,
...
* Uncomment aurora_fmc_top      block in generate loop for bitrates less than 640 Mbps.
* Uncomment aurora_fmc_top_xapp block in generate loop for bitrates more than 640 Mbps.
**/
